    ...
    <div class="row">
        <div class="col-lg-3 sidebar">
         ...
         <div class="col-lg-9">
                ...
                <h1>living Place: {{$userResearcher->livingPlace}} </h1>
                <h1>City Name: {{$userResearcher->cityName}} </h1>
                <h1>Country Name: {{$userResearcher->country}} </h1>
                <h1>Current Work: {{$userResearcher->currentWork}} </h1>
                <h1>Educational Level: {{$userResearcher->educationalLevel}} </h1>
                <h1>Voluntary Experiance: {{$userResearcher->voluntaryYears}} </h1>
                <h1>Date Of Birth: {{$userResearcher->dateOfBirth}} </h1>
