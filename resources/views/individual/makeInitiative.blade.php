...
<form class="col-lg-12" role="form" method="POST" action="{{ route('makeInitiativePost') }}">{{ csrf_field() }}
                  <div class="row">
                    <div class="col-12">
                      <h4 class="greencolor">Make Initiative</h4>
                      <hr />
                    </div>
              ...
              {{--  --}}
               <div class="  col-sm-6 col-md-3 form-group{{ $errors->has('firstName') ? ' has-error' : '' }}">
                   ...
                   <div class="">
                      <input id="name" type="text" class="form-control" name="firstName" value="{{old('firstInEnglish') }}"
                      required="required" />
              ...
              <div class="col-sm-6 col-md-3  form-group{{ $errors->has('lastName') ? ' has-error' : '' }}">
                  ...
                  <div class="">
                      <input id="name" type="text" class="form-control" name="lastName" value="{{ old('lastInEnglish') }}"
                      required="required" />
              ...
              <div class="col-sm-6 col-md-3  form-group{{ $errors->has('ARfirst') ? ' has-error' : '' }}">
                  ...
                  <div class="">
                      <input id="name" type="text" class="form-control" name="ARfirst" value="{{  old('firstInArabic') }}"
                      required="required" />
              ...
              <div class="col-sm-6 col-md-3  form-group{{ $errors->has('ARlast') ? ' has-error' : '' }}">
                  ...
                  <div class="">
                      <input id="name" type="text" class="form-control" name="ARlast" value="{{  old('lastInArabic') }}"
                      required="required" />
